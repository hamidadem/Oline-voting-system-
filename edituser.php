...
<td><div style="clear: both"></div>
		...
		<td><div id="right">
            <div class="desk">
           <h1 align="right"><?php 
echo '<img src="img/people.png" width="40px" height="30px">&nbsp;'.'<font face="times new roman" color="green" size="3">Hi,&nbsp;'.$FirstName."&nbsp;".$middleName." ".'</font>';?></h1>
<br><br>
<?php
$ctrl = $_REQUEST['key'];
...
?>
 ...
 <tr>
 <th colspan="2" bgcolor="#51a351"><font color="white">Edit User Account</font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="manage_account.php" title="Close"><img src="img/close_icon.gif"></a></th>
 </tr>
<tr>
...
?>
 ...
 <?php
  ...
  $update = mysql_query("update user set fname='$fname',mname='$mname',lname='$lname', sex='$sex',role='$role',username='$username' 
	,password='$password'
