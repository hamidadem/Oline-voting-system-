...
<td colspan="2" bgcolor="#51a351" id="Menus" style="height:auto;border-radius:12px;">
		...
		<ul>
			<li class="active"><a href="e_registrar.php">Home</a></li>
...
function displayDiv(prefix,suffix) 
{
 ...
 <table id="contentbox">
	...
	$sel=mysql_query("SELECT * FROM candidate");
			echo '<table align="center" style="width:500px;border:1px solid #51a351;border-radius:10px;" id="vtable"><tr>';
			echo '<th bgcolor="#51a351" width="100px"><font color="white" size="2">Party Name.</th><th bgcolor="#51a351"><font color="white" size="2">Name.</th><th bgcolor="#51a351"><font color="white" size="2">Sex</th><th bgcolor="#51a351"><font color="white" size="2">Age</th></tr>';
			$rowcolor=0;
...
print( "</table>");
				...
				<div id="div4" style="display:none;">
					...
					<u><center><h2>Voters</h2></center></u>
						...
						echo'<p valign="bottom" align="right"><form><input type="button" style="width:30%;height:30px;color:#2E8B57;
					   text-transform:capitalize;Font-weight:bolder;font-size:15px"; value="Print" onclick="window.print();"></form></p>';
	$sel=mysql_query("SELECT * FROM voter");
			echo '<table style="width:500px;border:1px solid #51a351;border-radius:10px;" id="vtable"><tr>';
			echo '<th bgcolor="#51a351"><font color="white" size="2">Name.</th><th bgcolor="#51a351" ><font color="white" size="2">Age</th>
			<th bgcolor="#51a351" ><font color="white" size="2">sex</th>
			<th bgcolor="#51a351" ><font color="white" size="2">Station</th>
			<th bgcolor="#51a351" ><font color="white" size="2">Status</th>
			</tr>';
			$rowcolor=0;
			$intt=mysql_num_rows($sel);
			echo"<br><br>";
