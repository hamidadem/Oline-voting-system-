...
<td><?php
						...
						{
						?>
                       			 <a href="status.php?status=<?php echo $row['u_id'];?>" onclick="return confirm('do you want to activate (<?php echo $fname?>)');">
						...
						{
						?>
                       			 <a href="status.php?status=<?php echo $row['u_id'];?>" onclick="return confirm('do you want to De-activate (<?php echo $fname?>)');"> 
