...
?>
 ...
 <tr>
 <th colspan="2" bgcolor="#51a351" height="25px"><font color="white">Edit Voter Information</font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="reg_voter.php" title="Close"><img src="img/close_icon.gif"></a></th>
 </tr>
<tr>
...
<tr><td>Station:</td><td><input  type='text' id='station' name='station' value="<?php echo "$r6"?>"></td></tr>
...
?>
 ...
 <?php
  if(isset($_POST['update']))
  {
				...
				$work=$_POST['work'];
  $update = mysql_query("update voter set fname='$fname',mname='$mname',lname='$lname', sex='$sex',age='$age',station='$station',work='$work' 
	,password='$password'
  WHERE vid='{$vid}'") or die(mysql_error());
  if(!$update)
  {
