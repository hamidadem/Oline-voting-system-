...
{
$sql="INSERT INTO voter (vid,fname,mname,lname,age,sex,work,phone,email,station,password,status)
VALUES
('$vid','$fname','$mname','$lname','$age','$sex','$job','$phone','$email','$psname','$pass','0')";
...
<tr bgcolor="#51a351" ><th colspan="2" height='30px'><font color="#ffffff">Add new voter</font><a href="reg_voter.php"><img align="right"src="img/close_icon.gif" title="close"></a></th></tr>
<tr>
<td><br>
</td>
<td>
...
<tr>
<td>
<font color="red">*</font><label>Station:</label>
</td>
<td>
