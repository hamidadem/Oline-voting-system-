...
if(!$result){
die("user is not registered!".mysql_error());
}
if($count==1){
...
?>
  <form id="form1" method="POST" action="editreg.php"  onsubmit='return formValidation()'>

 <table valign='top' align="center" style="border-radius:5px;border:1px solid #336699">
 <tr>
 <th colspan="2" bgcolor="#51a351"><font color="white">Edit User Account</font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="elect_registrar.php" title="Close"><img src="img/close_icon.gif"></a></th>
 </tr>
<tr>
...
<input  type='hidden' id='user_id' name="us_id" value="<?php echo "$r4"?>">
...
?>
 ...
 <?php
  ...
  $update = mysql_query("update user set fname='$fname',mname='$mname',lname='$lname', sex='$sex',role='registrar',username='$username' 
	,password='$password'
  WHERE u_id='{$u}'") or die(mysql_error());
  if(!$update)
  {
  ...
  {
  //echo'<meta content="4;elect_registrar.php" http-equiv="refresh"/>';
echo "<script>window.location='elect_registrar.php';</script>";
