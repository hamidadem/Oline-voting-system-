...
<select name="station" required>
	<?php $CYS_query=mysql_query("select * from station")or die(mysql_error());
...
<td>
<input type="text" name="fname" id="fn"  onkeypress="return chkAplha(event,'error12')" onblur="chkblnk('fn','error12')"required x-moz-errormessage="Enter Your First Name"/>
...
<td>
<input type="text" name="mname" id="mname"  onkeypress="return chkAplha(event,'error11')" required x-moz-errormessage="Enter Your Middle Name"/>
...
<td>
<input type="text" name="lname" id="lname"  onkeypress="return chkAplha(event,'error10')"required x-moz-errormessage="Enter Your Last Name"/>
...
<tr><td><br></td></tr>
	   ...
	   if (isset($_POST['log'])){ 
		...
		$lname=$_POST['lname'];
	    $password=$_POST['pass'];
	    $sql ="SELECT * FROM voter WHERE fname='$fname' AND mname='$mname' AND lname='$lname' AND password='$password'";
