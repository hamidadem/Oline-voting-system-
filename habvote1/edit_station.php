...
?>
 ...
 <tr>
 <th colspan="2" bgcolor="#51a351" height="25px"><font color="white">Edit Polling station</font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="stations.php" title="Close"><img src="img/close_icon.gif"></a></th>
 </tr>
<tr>
<input type='hidden' name='psid' value="<?php echo "$r1"?>">
<tr><td>Station Name:</td><td><input type='text' name='psname' id='psname' value="<?php echo "$r2"?>"></td></tr>
...
?>
 ...
 <?php
  if(isset($_POST['update']))
  {
				...
				$city=$_POST['city'];
				$psid=$_POST['psid'];
  $update = mysql_query("update station set psname='$psname',kebele='$kebele',city='$city'
  WHERE psid='{$psid}'") or die(mysql_error());
  if(!$update)
  {
