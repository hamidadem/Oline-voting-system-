...
{
$sql="INSERT INTO candidate (fname,mname,lname,u_id,sex,age,work,education,phone,email,experience,party_name,party_symbol,candidate_photo,username,password)
VALUES
('$fname','$mname','$lname','$user_id','$sex','$age','$work','$edu','$phone','$email','$experience','$party_name','$party_symbol','$candidate_photo','$usern','$passw')";

if (!mysql_query($sql,$conn))
  {
         echo'  <p class="wrong">Error</p>'.mysql_error();
    }
  else
  {
...
<tr bgcolor="#51a351" ><th colspan="2" ><font color="#ffffff">Add New Candidate</font><a href="ov_candidate.php"><img align="right"src="img/close_icon.gif" title="close"></a></th></tr>
<tr>
<td><br>
</td>
<td>
...
<tr>
<td colspan="2"><center><u><font style="text-transform:capitalize;"face="times new roman" color="green" size="3">Part I. Personal information</font></u></center><br>
</td>
</tr>
...
<tr>
<td colspan="2"><center><u><font style="text-transform:capitalize;"face="times new roman" color="green" size="3">Part II. Party information</font></u></center><br>
</td>
</tr>
<tr>
<td>
