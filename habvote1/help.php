...
<td><div style="clear: both"></div>
		...
		<td><div id="right">
            <div class="desk">
           <h1>inorder to vote  every voter should follow the basic rules</h1>
<h1>The age should be >=18</h1>
<h1> They should be live in acountry six monthe ago</h1>
<h1>He/She should be free from any crime</h1>
